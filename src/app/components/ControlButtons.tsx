    ...
    <div className="w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <button
          ...
          className="px-8 py-4 bg-[#5a8f7b] text-white rounded-3xl hover:bg-[#4d7a68] transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 font-semibold flex items-center justify-center gap-3"
        >
          {isPaused ? (
            <>
        ...
        <button
          ...
          className="px-8 py-4 bg-[#5a8f7b] text-white rounded-3xl hover:bg-[#93c9a8] transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none font-semibold flex items-center justify-center gap-3"
